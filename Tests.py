...
def test_all():
    ...
    print(
        colors.GREEN + "ALL TESTS WERE SUCCESSFUL" + colors.ENDC if b_succ else colors.RED + "SOME TESTS FAILED" + colors.ENDC)
...
class Test(TestCase):
    def test_geldfluss(self):
        self.assertEquals(10, header.geldfluss("Neue Werkzeuge"))


class Test(TestCase):
    def test_verdaechtiger_empfaenger(self):
        self.assertEqual(15, header.verdaechtiger_empfaenger(1))
